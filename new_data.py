...
df2, _ = ek.get_data(list1, fields=['TR.CommonName', 'TR.F.STDebtCurrPortOfLTDebt.date', 'TR.F.STDebtCurrPortOfLTDebt',
...
# df2.to_csv(r"C:\\Users\\morte\\PycharmProjects\\Master\\gathered_data.csv", index=False)